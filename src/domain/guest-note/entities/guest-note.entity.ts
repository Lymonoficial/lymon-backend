...
import { GuestNoteTypeEnum } from '@/domain/guest-note/value-objects/guest-node-type-enum.vo';
import { GuestNoteStatusEnum } from '@/domain/guest-note/value-objects/guest-node-status-enum.vo';
